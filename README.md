# هم‌بن — فروشگاه آنلاین تعاونی مواد غذایی

هم‌بن یک فروشگاه آنلاین تعاونی است که محصولات غذایی باکیفیت، محلی و تولید خود تعاونی را با منشأ مشخص، شماره بچ و کنترل کیفیت مستند از تولیدکننده به سفره خانوارها می‌رساند.
